...
Message.prototype.urlargs = function(args) {
  if ('object' === typeof args)
    this.urlargs = args;
  else 
    console.log("invalid url-args");


  //this.payload.aps["url-args"] =[ key, value];
  return this;
}
 ...
 * ### .category (identifier)
 *
 * Set the message category so that the applciation
 * receiving the message knows how to handle the message.
 *
 * ```js
 ...
 */
 Message.prototype.category = function (category) {
   if ('string' !== typeof category) return this;
...
Message.prototype.contentAvailable = function (contentAvailable) {
  if (contentAvailable) {
    ...
    delete this.settings['content-available'];
  }
  return this;
};
...
Message.prototype.serialize = function () {
  ...
  if (this.urlargs) {
    payload.aps["url-args"] = this.urlargs;

  }
  console.log("payloooad", payload);
